...
nsp, nmodes, gmodel = setGasModel('air-11sp.lua')
...
config.reactions_file = 'air-11sp-6r.lua'
config.dimensions = 2
...
if useOldSoln then
   ...
   d = Vector3:new{x=-0.15*Rc, y=0.0}
   e = Vector3:new{x=-0.15*Rc, y=0.8*Rc}
   f = Vector3:new{x=0.0, y=1.4*Rc}
   g = Vector3:new{x=Rc,  y=1.4*Rc}
